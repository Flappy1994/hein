		...
		<div class="clearfix">
			<div class="vc_row wpb_row vc_row-fluid">
				<div class="wpb_column vc_column_container vc_col-sm-8">
					...
					<?php 
						echo do_shortcode("[blog mc_pagination='0' items_per_page='-1' layout_type='1' ids='-' category='-' show_post_title='1' read_more='1' show_post_categories='1' show_post_author='1' show_post_comments_box='1' show_post_comments_label='0' show_post_date_footer='0' show_post_comments_footer='0' lightbox_icon_color='green_light' el_position='first last']");
					 ?>
					</div>
				</div>
