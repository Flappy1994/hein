<?php
function theme_gallery_shortcode($atts, $content, $tag)
{
	global $themename;
	global $post;
			...
			$output .= '<li id="gallery-details-' . $post->post_name . '" class="gallery_item_details clearfix">
					...
					if((int)$display_social_icons)
					{
						...
						if(!$arrayEmpty)
						{
							...
							{
								if($icon_type[$i]!="")
									$output .= '<li><a class="social_icon" href="' . $icon_url[$i] . '"' . ($icon_target[$i]=='new_window' ? ' target="_blank"' : '') . ' title="" style="background-image: url(\'' . get_stylesheet_directory_uri() . '/images/social_body/' . $icon_color[$i] . '/' . $icon_type[$i] . '.png\');">&nbsp;</a></li>';
							}
							$output .= '</ul>';
						}
					}
					...
					if(get_the_excerpt()!="")
						...
						if((int)$display_social_icons)
						{
							...
							if(!$arrayEmpty)
							{
								...
								{
									if($icon_type[$i]!="")
										$output .= '<li><a class="social_icon" href="' . $icon_url[$i] . '"' . (isset($icon_target[$i]) && $icon_target[$i]=='new_window' ? ' target="_blank"' : '') . ' title="" style="background-image: url(\'' . get_stylesheet_directory_uri() . '/images/social_body/' . $icon_color[$i] . '/' . $icon_type[$i] . '.png\');">&nbsp;</a></li>';
								}
								$output .= '</ul>';
							}
						}
