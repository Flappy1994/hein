    ...
    function widget($args, $instance) 
	{
		...
		<ul class="contact_data page_margin_top">
			...
			for($i=0; $i<count($icon_type); $i++)
			{
				if($icon_type[$i]!=""):
			?>
			<li class="clearfix"><span class="social_icon" style="background-image: url('<?php echo get_stylesheet_directory_uri() . "/images/social_body/" . $icon_color[$i] . "/" . $icon_type[$i] . ".png');"; ?>"></span><p class="value"><?php echo $icon_value[$i];?></p></li>
			<?php
				endif;
			}
			?>
