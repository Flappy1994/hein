    ...
    class CPAPPB_iCalExport extends CPAPPB_BaseAddon
    {
			...
			<div id="metabox_basic_settings" class="postbox" >
				...
				<div class="inside">
                   ...
                   <table class="form-table">
                    <tr valign="top">
                    <th scope="row"><?php _e('iCal timezone difference vs server time', 'appointment-hour-booking'); ?></th>
        ...
        function attach_ical_file( $attachments, $params, $form_id) 
        {
            ...
            foreach($data["apps"] as $app)
            {
                ...
                $buffer .= "DESCRIPTION:Booking for ".str_replace("<br>",'\n',str_replace("<br />",'\n',str_replace("\r",'',str_replace("\n",'\n',$params["email"])) ))."\n";
                ...
                $buffer .= "SUMMARY:Booking for ".str_replace("\n",'\n',$params["email"])."\n";
