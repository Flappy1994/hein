    ...
    $(document).ready(function () {
        ...
        $('#plugin-business-hours-submit').on('click', function (event) {
            ...
            for (var i = 0; i < times.length; i++) {
                ...
                if ($("input[name='saisonal_business_hours["+i+"][from]']")) {
                    if($("input[name='saisonal_business_hours["+i+"][from]']").val()>$("input[name='saisonal_business_hours["+i+"][to]']").val())
                    {
                        status = false;
                        $("input[name='saisonal_business_hours["+i+"][from]']").attr('style', 'border:1px solid red')
                        $("input[name='saisonal_business_hours["+i+"][to]']").attr('style', 'border:1px solid red')
                    }
                }
